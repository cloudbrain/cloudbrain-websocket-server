...
def _rt_stream_connection_factory(rabbitmq_address, rabbitmq_user, rabbitmq_pwd):
    """
...
class WebsocketServer(object):
    def __init__(self, ws_server_port, rabbitmq_address, rabbitmq_user, rabbitmq_pwd):
        self.rabbitmq_address = rabbitmq_address
        self.rabbitmq_user = rabbitmq_user
        self.rabbitmq_pwd = rabbitmq_pwd
    ...
    def start(self):
        RtStreamConnection = _rt_stream_connection_factory(self.rabbitmq_address,
                                                           self.rabbitmq_user,
                                                           self.rabbitmq_pwd)
        ...
        print "Real-time data server running at http://localhost:%s" % self.ws_server_port
